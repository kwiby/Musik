...
fun GenreOption(
	...
	MetadataField(
		query = editMetadataViewModel.genreQuery.value,
		onValueChange = { editMetadataViewModel.genreQuery.value = it },
		placeholderText = stringResource(R.string.edit_metadata_placeholder_genre)
	)
