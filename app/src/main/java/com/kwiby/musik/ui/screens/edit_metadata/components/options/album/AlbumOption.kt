package com.kwiby.musik.ui.screens.edit_metadata.components.options.album
...
fun AlbumOption(
	...
	OptionHeader(stringResource(R.string.edit_metadata_album))
	Spacer(Modifier.height(dimensionResource(R.dimen.option_header_bottom_padding)))

	MetadataField(
		query = editMetadataViewModel.albumQuery.value,
		onValueChange = { editMetadataViewModel.albumQuery.value = it },
		placeholderText = stringResource(R.string.edit_metadata_placeholder_album)
	)
